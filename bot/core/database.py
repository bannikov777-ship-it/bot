...
def seed_cities():
    ...
    if cur.fetchone()[0] == 0:
        cities = [
            ...
            (2, 'Озерный Край', 'Город, раскинувшийся в центре большого озера. Здесь царит атмосфера спокойствия, но за стенами города скрываются опасные твари.', 'photo-240828623_456239022')
        ]
